...
/**
 * The <code>trainRemote</code> class provides a Java RMI-compliant interface to MATLAB 
 * functions. The interface is compiled from the following files:
 * <pre>
 *  C:\Program Files\MATLAB\R2017a\bin\test\Kod\train_word.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>trainRemote</code> 
 ...
 * generate RMI server proxy objects for instances of speechrec.train.
 */
public interface trainRemote extends Poolable
{
    /**
