...
/**
 * The <code>kayitRemote</code> class provides a Java RMI-compliant interface to MATLAB 
 * functions. The interface is compiled from the following files:
 * <pre>
 *  C:\Program Files\MATLAB\R2017a\bin\test\Kod\Untitled.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>kayitRemote</code> 
 ...
 * generate RMI server proxy objects for instances of speechrec.kayit.
 */
public interface kayitRemote extends Poolable
{
    /**
     * Provides the standard interface for calling the <code>Untitled</code> MATLAB 
     ...
     */
    public Object[] Untitled(Object... rhs) throws RemoteException;
