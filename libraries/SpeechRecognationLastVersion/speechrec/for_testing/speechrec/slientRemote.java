...
/**
 * The <code>slientRemote</code> class provides a Java RMI-compliant interface to MATLAB 
 * functions. The interface is compiled from the following files:
 * <pre>
 *  C:\Program Files\MATLAB\R2017a\bin\test\Kod\recs.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>slientRemote</code> 
 ...
 * generate RMI server proxy objects for instances of speechrec.slient.
 */
public interface slientRemote extends Poolable
{
    /**
     * Provides the standard interface for calling the <code>recs</code> MATLAB function 
     ...
     */
    public Object[] recs(Object... rhs) throws RemoteException;
