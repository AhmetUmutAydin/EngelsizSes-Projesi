...
/**
 * The <code>testwordRemote</code> class provides a Java RMI-compliant interface to 
 * MATLAB functions. The interface is compiled from the following files:
 * <pre>
 *  C:\Program Files\MATLAB\R2017a\bin\test\Kod\test_word.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>testwordRemote</code> 
 ...
 * generate RMI server proxy objects for instances of speechrec.testword.
 */
public interface testwordRemote extends Poolable
{
    /**
