...
/**
 * The <code>testword</code> class provides a Java interface to MATLAB functions. 
 * The interface is compiled from the following files:
 * <pre>
 *  C:\Program Files\MATLAB\R2017a\bin\test\Kod\test_word.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>testword</code> instance 
 * when it is no longer needed to ensure that native resources allocated by this class 
 * are properly freed.
 * @version 0.0
 */
public class testword extends MWComponentInstance<testword>
{
    /**
     ...
     */
    private testword (final MWMCR mcr) throws MWException
    {
        super(mcr);
        // add this to sInstances
        synchronized(testword.class) {
            sInstances.add(this);
        }
    }

    /**
     * Constructs a new instance of the <code>testword</code> class.
     * @throws MWException An error has occurred during the function call.
     */
    public testword() throws MWException
    {
    ...
    /**
     * @deprecated Please use the constructor {@link #testword(MWComponentOptions componentOptions)}.
     * The <code>com.mathworks.toolbox.javabuilder.MWComponentOptions</code> class provides an API to set the
     * path to the component.
     * @param pathToComponent Path to component directory.
     * @throws MWException An error has occurred during the function call.
     */
    public testword(String pathToComponent) throws MWException
    {
        this(SpeechrecMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    
    /**
     * Constructs a new instance of the <code>testword</code> class. Use this constructor 
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public testword(MWComponentOptions componentOptions) throws MWException
    {
    ...
    public static void main (String[] args)
    {
        try {
            ...
            mcr.runMain( sTest_wordSignature, args);
            mcr.dispose();
        } catch (Throwable t) {
            t.printStackTrace();
        }
